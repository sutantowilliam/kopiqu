...
<div class="container">
	<div class="d-flex flex-row my-3 justify-content-between">
		<h1 class="category-title" >ADD PRODUCT</h1>
	</div>
	...
	<div class=" bg-light center p-3 my-3 d-flex flex-column" >
			<form>
				<div class="form-group">
				    ...
				    <input type="number" min=0.1 step="any" class="form-control" id="weight-input" placeholder="">
				    <div class="invalid-feedback">
			          Please fill product weight
			        </div>
			        <label class="font-weight-bold">Price</label>
				    <input type="number" min=100 class="form-control" id="price-input" placeholder="">	    
				    <div class="invalid-feedback">
			...
			<button id="add-button" class="btn btn-success mb-2">ADD PRODUCT</button>
		</div>
</div>
